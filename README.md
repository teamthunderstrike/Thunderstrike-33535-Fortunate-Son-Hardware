...
# Fortunate Son — Competition Edition Hardware
Visit our [Releases page](https://github.com/teamthunderstrike/Thunderstrike-33535-Fortunate-Son-Hardware/releases) to download the source files.
...
Inside the CAD file, you will find several hidden sub-components representing alternative hardware configurations:
* **Shooter Structure (Aluminum vs. Acrylic)**: Switch between Acrylic and Aluminum side panels. Aluminum is preferred for vibration damping.
